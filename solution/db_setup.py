...
data = [['Afghanistan','AF','AFG','Asia'],
  ...
  # Замените на вашу строку извлеченных данных
...
cursor.executemany("INSERT INTO countries (name, alpha2, alpha3, region) VALUES (?, ?, ?, ?)", data)
conn.commit()
conn.close()

print("Данные успешно импортированы в countries.db")